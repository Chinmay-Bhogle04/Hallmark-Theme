...
//       });
  ...
  var ajaxCartDrawer = {
    ...
    AjaxcartFreeProduct: function(isLoading){
      var cartTotal = $('.mm-ajaxcart').find('.summary .price').attr('data-Cart-Total');
      console.log(cartTotal);
      var hasFreeProduct = false;
      var itemCount = 0;
      var cartTotalBeforeFreeGift;
      ...
      if(hasFreeProduct){
        var cartTotalBeforeFreeGift = cartTotal - 0;
        console.log(cartTotalBeforeFreeGift);
      }
      if(cartTotal>14998 && !hasFreeProduct){
        var freeProduct = {
          "id": 41179800666293,
          "quantity": 1
        }
      ...
      } else if(hasFreeProduct && cartTotalBeforeFreeGift<14999 ){
        var freeProduct = {
          "id": 41179800666293,
          "quantity": 0
        }
  ...
  $(document).on('click', '.mm-ajaxcart-open,.site-header__cart', function(e) {
    e.preventDefault();
    ajaxCartDrawer.AjaxcartHideLoader();
  })
