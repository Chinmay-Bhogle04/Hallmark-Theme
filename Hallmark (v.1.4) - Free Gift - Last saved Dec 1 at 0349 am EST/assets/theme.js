...
//       });
  ...
  var ajaxCartDrawer = {
    ...
    AjaxcartFreeProduct: function(isLoading){
      ...
      if(hasFreeProduct){
        var cartTotalBeforeFreeGift = cartTotal - 7999;
		console.log(cartTotalBeforeFreeGift);
      }
      if(cartTotal>14800 && !hasFreeProduct){
        var freeProduct = {
          "id": 41179800666293,
          "quantity": 1
        }
      ...
      } else if(hasFreeProduct && cartTotalBeforeFreeGift<14900 ){
        var freeProduct = {
          "id": 41179800666293,
          "quantity": 0
        }
