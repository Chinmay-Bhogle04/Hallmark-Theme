...
slate.Variants = (function() {
  ...
  Variants.prototype = Object.assign({}, Variants.prototype, {
    ...
    _onSelectChange: function() {
      ...
      // On variant sku change
      $('.product-single__meta .product-varient_sku').text(variant.sku);
    ...
    _updatePrice: function(variant) {
      $('.product__price').attr('[data-product-selling-price]',variant.price);
      if (
...
theme.Cart = (function() {
  ...
  Cart.prototype = Object.assign({}, Cart.prototype, {
    ...
    _createCart: function(state) {
      ...
      $('[data-cart-subtotal]').html(theme.Currency.formatMoney(state.total_price,theme.moneyFormatWithoutCurrency))
...
theme.Product = (function() {
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _updateLiveRegion: function(evt) {
      ...
      console.log(variantQuantity[variant.id]);
      if(variant.available){
        if(variantQuantity[variant.id]<1){
          $('.shipping-information-date').show();
          this.addToCartText.innerHTML = 'Pre Order';
          $('.preorder-shipping').show();
          $('.normal-shipping').hide();
        }else{
          $('.shipping-information-date').show();
          this.addToCartText.innerHTML = 'Add to cart';
          $('.preorder-shipping').hide();
          $('.normal-shipping').show();
        }
        $('#BIS_trigger').hide();
      }else{
        $('.shipping-information-date').hide();
        $('#BIS_trigger').show();
      }
    ...
    _enableAddToCart: function(message) {
      ...
      this.addToCart.classList.remove(this.classes.variantHide);
    },
    ...
    _disableAddToCart: function(message) {
      ...
      this.addToCart.classList.add(this.classes.variantHide);
    },
...
//   function myTimer() {
//     //     console.log(1);
//     if ($('#mhaRnProduct').children().length > 0 ) {
//       console.log(1);
//       myStopFunction();
//       var htmlCode = '<span>Join waiting list</span>';
//       $("#custom_test").html(htmlCode).addClass("btn");
//     }
//   }
  ...
  var homePage = {
    initBannerSlider: function() {
      var bannerSlider = $('.slideshow__banner.active-slider');
  ...
  var commonPages = {
    ...
    announcementSlider: function() {
      ...
      if(announcement_slider.length) {
        announcement_slider.slick({
          ...
          autoplaySpeed: 5000,
          pauseOnHover: true,
          prevArrow: '<button type="button" class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 22"><defs><style>.ant-sl-prev-a{fill:#fff;opacity:0;}.ant-sl-prev-b{fill:none;stroke:#fff;stroke-linecap:round;stroke-width:2px;}</style></defs><g transform="translate(-37 -751)"><rect class="ant-sl-prev-a" width="15" height="22" transform="translate(37 751)"/><g transform="translate(40.666 755.577)"><line class="ant-sl-prev-b" x1="6.69" y2="6.69"/><line class="ant-sl-prev-b" x1="6.69" y1="6.69" transform="translate(0 6.69)"/></g></g></svg><span class="visuallyhidden">Slick arrow</span></button>',
          nextArrow: '<button type="button" class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 22"><defs><style>.ant-sl-next-a{fill:#fff;opacity:0;}.ant-sl-next-b{fill:none;stroke:#fff;stroke-linecap:round;stroke-width:2px;}</style></defs><g transform="translate(-203 -15.861)"><rect class="ant-sl-next-a" width="17" height="23" transform="translate(203 15.861)"/><g transform="translate(208 20.589)"><line class="ant-sl-next-b" x2="6.69" y2="6.69"/><line class="ant-sl-next-b" y1="6.69" x2="6.69" transform="translate(0 6.69)"/></g></g></svg><span class="visuallyhidden">Slick arrow</span></button>',
        });
      }
    },
    
    collectionListSlider: function() {
      var swiper = new Swiper('.swiper-collection-container', {
        slidesPerView: 4,
        spaceBetween: 30,
        scrollbar: {
          el: '.swiper-scrollbar',
    ...
    promotionPopup: function() {
      ...
      if(popup != 'open'){
        $("#size-chart-popup").css({"visibility":"visible","opacity":"1"});
      }

      $("#size-chart-popup").click(function(e){
        if($(e.target).closest(".popup").length<1){
          $(this).css({"visibility":"hidden","opacity":"0"});
          $("body").css("overflow","unset").removeClass('mm-popup--opened');
          Cookies.set('popup', 'open');
        }
      });

      $("#size-chart-popup .close-popup").click(function(e){
    ...
    thankYouPopup: function() {
      $("#thankyou-popup").click(function(e){
        if($(e.target).closest(".popup").length<1){
          window.location.href = "/pages/contact-us"
        }
      });

      $("#thankyou-popup .overlay .close-popup").click(function(e){
        window.location.href = "/pages/contact-us"
      });
    },
    
    filterDropdown: function(){
      $('.filter-wrapper .button-wrapper').on('click',function(){
        if($(this).hasClass('active')){
          $('.filter-wrapper .button-wrapper').removeClass('active');
        }else{
          $('.filter-wrapper .button-wrapper').removeClass('active');
          $(this).addClass('active');
        }
      });
      $('.button-text-wrapper .button-wrapper').on('click',function(){
        if($(this).hasClass('active')){
          $('.button-group-wrapper .button-wrapper').removeClass('active');
        }else{
          $('.button-group-wrapper .button-wrapper').removeClass('active');
          $(this).addClass('active');
        }
...
//       $(document).on('click','.nav-level-1 .nav-link',function(e){
//         if($(this).closest('.nav-item').hasClass('nav-expand')){
//           var dataTrigger = $(this).data('level')
//           e.preventDefault();
//           $(this).closest('.nav-item').find('.'+dataTrigger).addClass('active');
//           if(dataTrigger=="menu-level-2"){
//             $(this).closest('.nav-item').addClass('active').find('.nav-items .menu-level-3').eq(0).slideDown();
//           }
//         }
//       });
      
      $(document).on('click','.nav-level-1 .svg-parent-wrapper',function(e){
        if($(this).closest('.nav-item').hasClass('nav-expand')){
          var dataTrigger = $(this).data('level')
          e.preventDefault();
          $(this).closest('.nav-item').find('.'+dataTrigger).addClass('active');
          if(dataTrigger=="menu-level-2"){
            $(this).closest('.nav-item').addClass('active').find('.nav-items .menu-level-3').eq(0).slideDown();
            $(this).closest('.nav-item').find('.nav-items .nav-item').eq(0).addClass('active');
          }
        }
      });

      $(document).on('click','.menu-level-2 .nav-link',function(e){
        if($(this).closest('.nav-item').hasClass('nav-expand')){
          var dataTrigger = $(this).data('level')
          e.preventDefault();
          $(this).closest('.menu-level-2').find('.nav-items').slideUp();
          $(this).closest('.menu-level-2').find('.nav-item').removeClass('active');
          if($(this).closest('.nav-item').find('.nav-items').is(':visible')){
            $(this).closest('.nav-item').removeClass('active').find('.nav-items').slideUp();
          }else{
            $(this).closest('.nav-item').addClass('active').find('.nav-items').slideDown();
          }
        }
      });
      
      $(document).on('click','.menu-level-2 .svg-parent-wrapper',function(e){
        if($(this).closest('.nav-item').hasClass('nav-expand')){
          var dataTrigger = $(this).data('level');
          e.preventDefault();
          $(this).closest('.menu-level-2').find('.nav-items').slideUp();
  ...
  var CartPage = {
    initQuantityHandler: function() {
      $(document).on("click", ".qty_minus", function(){
        var QuantityInput = $(this).parents('.cart__qty').find('.cart__qty-input'),
            QuantityValue = parseInt(QuantityInput.val()),
        	id = QuantityInput.attr("id");

        if (QuantityValue >= 1) {
          QuantityInput.val(QuantityValue - 1).trigger('change');        
        }
      });
      $(document).on("click", ".qty_plus", function(){
        var QuantityInput = $(this).parents('.cart__qty').find('.cart__qty-input'),
            UpdatedQuantity,
            QuantityLine = QuantityInput.attr('data-quantity-item'),
            QuantityValue = parseInt(QuantityInput.val());

        QuantityInput.val(QuantityValue + 1)
        UpdatedQuantity = parseInt(QuantityValue + 1);
  ...
  var passwordPage = {
    showPasswordForm: function(){
      $('.password-login .link--action').on('click',function(){
      	$('.newsletter-wrapper').hide();
        $('.password-content-wrapper').show();
        Cookies.set('clickPasswordLogin', 'Yes');
      });
      var passwordPageUrl = window.location.href; 
      console.log(passwordPageUrl);
      if(passwordPageUrl.indexOf('#LoginModal')>-1){
        $('.newsletter-wrapper').hide();
        $('.password-content-wrapper').show();
      }
    }
  ...
  commonPages.imageGridSlider();
  commonPages.announcementSlider();
  commonPages.promotionPopup();
  commonPages.thankYouPopup();
  commonPages.filterDropdown();
  commonPages.collectionListSlider();
  commonPages.mobileMegaMenu();
  passwordPage.showPasswordForm();
  CartPage.initQuantityHandler();
  ...
  var ajaxCartDrawer = {
    ...
    AjaxcartFreeProduct: function(isLoading){
      var cartTotal = parseInt($('.mm-ajaxcart').find('.summary .price').attr('data-Cart-Total'));
      console.log(cartTotal);
      var hasFreeProduct = false;
      var itemCount = 0;
      var freeItemPrice;
      $('.cart-popup-item-wrapper .cart-popup-item').each(function(){
        itemCount += 1;
        var itemVariant = $(this).data('variant-id');
        if(itemVariant == '41179800666293'){
          hasFreeProduct = true;
          freeItemPrice = $(this).data('item-price');
        }
      });
      if(cartTotal>14900 && !hasFreeProduct){
        var freeProduct = {
          "id": 41179800666293,
          "quantity": 1
        }
        $.ajax({
          ...
          dataType: 'json',
          success: function () {
            $.get('/cart?view=mm-ajax', function(cart) {
              $('.mm-ajaxcart').html(cart);
              //   Update cart icon count
              var NewCartCount = parseInt($('#CartPopupHeading span').text());
              ...
              $('[data-cart-count]').html(NewCartCount);
              ajaxCartDrawer.AjaxcartHideLoader(isLoading);
            })
          }
        });
      } else if(hasFreeProduct && freeItemPrice>0 ){
        var freeProduct = {
          "id": 41179800666293,
          "quantity": 0
        }
        ...
        ajaxCartDrawer.AjaxcartHideLoader(isLoading);
        $('.mm-ajaxcart .ajax-loader').addClass("hide");
      }
    },
    AjaxcartHideLoader: function(isLoading){
      if(!isLoading){
        ajaxCartDrawer.AjaxcartOpen();
        $('.product-form button[name="add"],.shopify-product-form .mm-ajax-add').find("span").removeClass("hide");
        $('.product-form button[name="add"],.shopify-product-form .mm-ajax-add').find("[data-loader]").addClass("hide");
      }
    },
    AjaxcartRender: function() {
      $('.mm-ajaxcart .ajax-loader').removeClass("hide");
      $.get('/cart?view=mm-ajax', function(cart) {
        $('.mm-ajaxcart').html(cart);
        $('.mm-ajaxcart .ajax-loader').removeClass("hide");
        ajaxCartDrawer.AjaxcartFreeProduct();
      });
    },
    AjaxcartRenderOnLoad: function() {
      $('.mm-ajaxcart .ajax-loader').removeClass("hide");
      $.get('/cart?view=mm-ajax', function(cart) {
        $('.mm-ajaxcart').html(cart);
        $('.mm-ajaxcart .ajax-loader').removeClass("hide");
        ajaxCartDrawer.AjaxcartFreeProduct('onloadData');
      })
    },
    AjaxcartChangeHandler: function(data) {
      ...
      $.ajax({
        ...
        success: function(cart) {
          ...
          $('[data-cart-count]').html(CartCount);
          $('.cart-popup__heading span').text(CartCount);
        }
      });
    },
    AjaxcartQuantityHandler: function() {
      ...
      $(document).on('change', '.quantity-input', function() {
        ...
        ajaxCartDrawer.AjaxcartChangeHandler(params);
      })
  ...
  ajaxCartDrawer.AjaxcartRenderOnLoad();
  ajaxCartDrawer.AjaxcartQuantityHandler();
  
  $(document).on('click', '.mm-ajaxcart-open,.site-header__cart', function(e) {
    e.preventDefault();
    ajaxCartDrawer.AjaxcartRender();
  })

  $(document).on('click', '.mm-ajaxcart-close, .mm-ajaxcart-overlay', function(e) {
    e.preventDefault();
    ajaxCartDrawer.AjaxcartClose();
  });
  
  //AJAX ADD TO CART PDP
  $(document).on('click', '.product-form button[name="add"],.shopify-product-form .mm-ajax-add', function(e) {
    e.preventDefault();
      ...
      $.ajax({
        ...
        success: function () {
          ...
          setTimeout(function () {
            ...
            $this.find("[data-loader]").addClass("hide");
          }, 500);
          
          //Call Cart JSON
          $.getJSON('/cart.js', function(cart) {
            var currentCartCount = cart.item_count;
            if (currentCartCount > 0) {
              $('#CartCount').removeClass('hide');	
            } else {
              $('#CartCount').addClass('hide');
            }
            $('[data-cart-count]').html(currentCartCount);
            $('.cart-popup__heading span').text(CartCount);
          });
        },
  ...
  $("button.shopify-payment-button__button.shopify-payment-button__button--unbranded").on("click",function(e){
    e.preventDefault();
    $(this).find('.checkout-text').addClass('hide');
    $(this).find('[data-loader]').removeClass('hide');
    var productItemValue = $('.product-template__container .product__price').attr('data-product-selling-price');
    var variantId = $('[name="id"]').find(":selected").val();
    if(productItemValue<14998){
      console.log(variantId);
      window.location.href = "/cart/"+variantId+":1";
    }else{
      //       ?id=VARIANTID1&quantity=1&id=VARIANTID2&quantity=1
      window.location.href = "/cart/"+variantId+":1,41179800666293:1"; 
    }
  });
  
  $(document).on('click','.mm-ajaxcart-content .cart-popup__cta-link',function(e){
    $(this).find('.checkout-text').addClass('hide');
    $(this).find('[data-loader]').removeClass('hide');
  });
  ...
  if(cartUrl.indexOf('?return=cart-page')>-1){
    $('body').addClass('mm-no-scroll');
    $('.mm-ajaxcart-overlay').addClass('has--active');
    $('.mm-ajaxcart').addClass('has--opened');
  ...
  // Search drawer fix to top when scroll
  $(window).scroll(function(){
    if($(document).scrollTop() >= 34) {
      $('#SearchDrawer').css('top', 0);
    }
    else {
      $('#SearchDrawer').css('top', 34);
    }
  });
